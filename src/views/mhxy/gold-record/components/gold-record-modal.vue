...
import { NAvatar, type FormInst, type FormItemRule, type SelectOption } from 'naive-ui';
...
function renderAccountLabel(option: SelectOption) {
  const account = option as unknown as ApiMhxy.Account;
  return h(
    'div',
    {
      style: {
